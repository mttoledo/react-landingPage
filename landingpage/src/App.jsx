      ...
      <section className="relative overflow-hidden">
        <div className="max-auto max-w-6xl px-4 py-20 relative">
          ...
          >
            <a
              href="#"
              className="inline-flex items-center justify-center gap-2 rounded-2xl bg-fuchsia-600 px-6 py-3 font-medium hover:bg-fuchsia-900 transition"
            >
            ...
            {["Velocidade", "Segurança", "Conversão"].map((label, i) => (
              ...
              >
                ...
                <p className="text-sm text-slate-400 mt-2">
                  ...
                  Perspiciatis optio voluptatem quisquam aperiam mollitia
                  repellendus.
                </p>
              </div>
            ))}
